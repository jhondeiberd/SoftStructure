    ...
    render(){
        ...
        return (
            <header>
                ...
                <br/>
                <form>
                    <input type="text" name="newname" id="newname" onChange={(event)=>this.changeName(event)}/>
                    {/* <button onClick={()=>this.changeName(document.getElementById("newname").value)}>Change name</button> */}
                    <button type="button" onClick={(event)=>this.changeName(document.getElementById("newname").value)}>Change name</button>
                </form>
            </header>
        )
    }
